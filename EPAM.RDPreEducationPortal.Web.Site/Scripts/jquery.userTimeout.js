		...
		var modal = function () {
			...
			if ($modalUI === 'bootstrap') {
				...
				if ($options.timer === true) {
                    $footer = $('<div class="modal-footer"><button id="btnStayLoggedIn" type="button" class="btn btn-primary" data-dismiss="modal">' +  $options.modalStayLoggedBtn + ' (<span id="countdowntimer">' + $countDownTimer + '</span>)</button></div>');
				} else {
					$footer = $('<div class="modal-footer"><button id="btnStayLoggedIn" type="button" class="btn btn-primary" data-dismiss="modal">' +  $options.modalStayLoggedBtn + '</button></div>');
				}
